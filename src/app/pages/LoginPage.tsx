...
import { DHeaderLight } from '../components/DHeader';

function TitleZone() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[751px]">
        <h1 className="leading-[48px] not-italic relative shrink-0 text-[40px] font-bold text-[rgba(3,3,6,0.88)] text-center">Персональные предложения для вашего бизнеса</h1>
        <p className="flex-[1_0_0] mt-[16px] leading-[24px] max-w-[751px] text-[16px] text-[rgba(3,3,6,0.88)] text-center">Узнайте, какие продукты и условия банк подготовил специально для вашей компании. <br />Введите ИНН, чтобы увидеть подборку</p>
    </div>
  );
}
