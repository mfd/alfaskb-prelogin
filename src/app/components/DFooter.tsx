export default function DFooter() {
  return (
    <div className="bg-[#000000] content-stretch flex flex-col items-center justify-end relative rounded-tl-[64px] rounded-tr-[64px] shrink-0 w-full px-[0px] py-[40px]" data-name="Footer">
        <div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0 text-[0px] text-[12px] text-[rgba(238,238,251,0.55)] w-[1140px] p-[0px]" data-name="SeoText">
