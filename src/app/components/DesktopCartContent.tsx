...
interface DesktopCartContentProps {
  items: CartItem[];
  onRemoveItem: (id: string) => void;
  onItemClick?: (productId: string) => void;
}

export default function DesktopCartContent({ items, onRemoveItem, onItemClick }: DesktopCartContentProps) {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="[Custom Content Part]">
      <div className="content-stretch flex flex-col items-start px-[16px] relative size-full">
        <div className="bg-white content-stretch flex flex-col gap-[32px] h-[496px] items-start pt-[16px] relative shrink-0 w-full" data-name="SwapMe">
                  ...
                  <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="TopSlot">
                    <div className={`content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px relative ${!hasDescription ? 'h-[44px]' : ''}`} data-name="TopSlot">
                      ...
                      <div className={`content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative ${!hasDescription ? 'justify-center self-stretch' : 'leading-[20px] not-italic'}`} data-name="Text Content">
                        ...
                        {description && (
                          <p className="font-['SF_Pro_Text:Regular',sans-serif] relative shrink-0 text-[14px] text-[rgba(4,4,19,0.55)] w-full whitespace-nowrap overflow-hidden text-ellipsis">
                            {description}
                          </p>
                        )}
                      </div>
