import svgPaths from "./svg-50qzz8jybw";
...
import imgIconView6 from "figma:asset/7186d95bd7ca1e12cf93fa27d3d2e711c96d8bb5.png";
import imgIconView7 from "figma:asset/0eea04d3331a3987901314e541223a620220b47e.png";
import imgIconView8 from "figma:asset/44690177e6c33f3932ceda7be51d1886a99a6432.png";
import imgIconView9 from "figma:asset/4469f5679ca3f6c22feca14fe50ece4db25237d6.png";
import { imgShapeContent } from "./svg-e7llm";
...
function BottomSheet() {
  return (
    <div className="absolute h-[460px] left-[269px] overflow-clip rounded-tl-[24px] rounded-tr-[24px] top-[1062px] w-[360px]" data-name="BottomSheet">
...
function BottomSheet1() {
  return (
    <div className="absolute h-[480px] left-[669px] overflow-clip rounded-tl-[24px] rounded-tr-[24px] top-[1042px] w-[360px]" data-name="BottomSheet">
      <div className="absolute bottom-0 content-stretch flex h-[887px] items-start left-0 rounded-tl-[24px] rounded-tr-[24px] w-[360px]" data-name="BottomSheet">
        <Overlay1 />
        <MainBody2 />
      </div>
...
function BottomSheet2() {
  return (
    <div className="absolute h-[520px] left-[1469px] overflow-clip rounded-tl-[24px] rounded-tr-[24px] top-[1002px] w-[360px]" data-name="BottomSheet">
      <div className="absolute bottom-0 content-stretch flex h-[887px] items-start left-0 rounded-tl-[24px] rounded-tr-[24px] w-[360px]" data-name="BottomSheet">
        <Overlay2 />
        <MainBody4 />
      </div>
...
function BottomSheet3() {
  return (
    <div className="absolute h-[540px] left-[1069px] overflow-clip rounded-tl-[24px] rounded-tr-[24px] top-[982px] w-[360px]" data-name="BottomSheet">
      <div className="absolute bottom-0 content-stretch flex h-[887px] items-start left-0 rounded-tl-[24px] rounded-tr-[24px] w-[360px]" data-name="BottomSheet">
        <Overlay3 />
        <MainBody6 />
      </div>
...
function BottomSheet4() {
  return (
    <div className="absolute h-[520px] left-[1869px] overflow-clip rounded-tl-[24px] rounded-tr-[24px] top-[1002px] w-[360px]" data-name="BottomSheet">
...
function BottomSheet5() {
  return (
    <div className="absolute h-[460px] left-[2269px] overflow-clip rounded-tl-[24px] rounded-tr-[24px] top-[1062px] w-[360px]" data-name="BottomSheet">
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="PreloginProductsIcon">
        <div className="content-stretch flex flex-col items-center justify-center max-h-[64px] max-w-[64px] min-h-[64px] min-w-[64px] relative shrink-0 size-[72px]" data-name="IconView">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute left-[1.4%] max-w-none size-full top-0" src={imgIconView6} />
          </div>
          <Content6 />
        </div>
      </div>
...
function BottomSheet6() {
  return (
    <div className="absolute h-[500px] left-[598px] overflow-clip rounded-tl-[24px] rounded-tr-[24px] top-[334px] w-[360px]" data-name="BottomSheet">
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="PreloginProductsIcon">
        <div className="content-stretch flex flex-col items-center justify-center max-h-[64px] max-w-[64px] min-h-[64px] min-w-[64px] relative shrink-0 size-[72px]" data-name="IconView">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute left-[-33.33%] max-w-none size-[142.1%] top-[-24.18%]" src={imgIconView7} />
          </div>
          <Content7 />
        </div>
      </div>
...
function BottomSheet7() {
  return (
    <div className="absolute h-[500px] left-[998px] overflow-clip rounded-tl-[24px] rounded-tr-[24px] top-[334px] w-[360px]" data-name="BottomSheet">
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="PreloginProductsIcon">
        <div className="content-stretch flex flex-col items-center justify-center max-h-[64px] max-w-[64px] min-h-[64px] min-w-[64px] relative shrink-0 size-[72px]" data-name="IconView">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[194.35%] left-[-36.3%] max-w-none top-[-42.36%] w-[179.01%]" src={imgIconView8} />
          </div>
          <Content8 />
        </div>
      </div>
...
function BottomSheet8() {
  return (
    <div className="absolute h-[460px] left-[1398px] overflow-clip rounded-tl-[24px] rounded-tr-[24px] top-[374px] w-[360px]" data-name="BottomSheet">
      <div className="absolute bottom-0 content-stretch flex h-[887px] items-start left-0 rounded-tl-[24px] rounded-tr-[24px] w-[360px]" data-name="BottomSheet">
        <Overlay8 />
        <MainBody16 />
      </div>
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="PreloginProductsIcon">
        <div className="content-stretch flex flex-col items-center justify-center max-h-[64px] max-w-[64px] min-h-[64px] min-w-[64px] relative shrink-0 size-[72px]" data-name="IconView">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[204.8%] left-[-49.01%] max-w-none top-[-55.06%] w-[193.61%]" src={imgIconView9} />
          </div>
          <Content9 />
        </div>
      </div>
...
function BottomSheet9() {
  return (
    <div className="absolute h-[440px] left-[1798px] overflow-clip rounded-tl-[24px] rounded-tr-[24px] top-[394px] w-[360px]" data-name="BottomSheet">
