  ...
  return (
    <div className="relative shrink-0 w-full" data-name="head">
      <div className="content-stretch flex flex-col gap-[16px] items-start px-[16px] relative w-full">
        <div
          className="content-stretch flex items-center justify-center relative shrink-0 w-[333px]"
        ...
        >
          <p className="flex-[1_0_0] font-['SF_Pro_Text:Regular',sans-serif] leading-[24px] min-h-px min-w-px not-italic relative text-[16px] text-[rgba(4,4,19,0.55)]">
            ...
            и предлагаем персональные спецпредложения
            по следующим продуктам:
          </p>
        </div>
      </div>
    </div>
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[187px]">
      <div
        className="bg-[#0cc44d] content-stretch flex items-center px-[8px] py-[2px] relative rounded-[6px] shrink-0"
        data-name="Status"
      >
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[187px]">
      <div
        className="bg-[#898991] content-stretch flex items-center px-[8px] py-[2px] relative rounded-[6px] shrink-0"
        data-name="Status"
      >
        <div className="flex flex-col font-['SF_Pro_Text:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[11px] text-[rgba(255,255,255,0.94)] uppercase whitespace-nowrap">
...
function Graphic() {
  return (
    ...
    >
      ...
      >
        <div
          className="content-stretch flex flex-col items-center justify-center max-h-[48px] max-w-[48px] min-h-[48px] min-w-[48px] relative shrink-0 size-[72px]"
          data-name="IconView"
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img
              alt=""
              className="absolute h-[117.64%] left-[-4.87%] max-w-none top-[-10%] w-[110.72%]"
              src={imgIconView1}
            />
          </div>
          <Content4 />
  ...
  return (
    ...
    >
      ...
      >
        <g id="Fixer">
          <path
            d={svgPaths.p30d5f900}
            fill="var(--fill-0, #030306)"
            fillOpacity="0.88"
            id="PaintMe"
          />
        </g>
  ...
  return (
    ...
    >
      ...
      >
        <Graphic />
        <div
          className="content-stretch flex flex-col gap-[8px] items-start leading-[20px] not-italic relative shrink-0 w-full"
        ...
        <div
          ...
          data-name="DCCardButton"
        >
          <div
            className="bg-white flex-[1_0_0] min-h-[40px] min-w-[88px] relative rounded-[12px]"
      ...
      >
        ...
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img
              alt=""
              className="absolute left-[7.17%] max-w-none size-full top-[-4.1%]"
              src={imgIconView2}
            />
          </div>
          <Content5 />
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="font-['SF_Pro_Text:Regular',sans-serif] relative shrink-0 text-[14px] text-[rgba(4,4,19,0.55)] w-full">
            Подключение за 0 ₽ и управление онлайн
          </p>
        </div>
        <div
          className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full"
      ...
      >
        ...
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img
              alt=""
              className="absolute left-[-22.22%] max-w-none size-[144.44%] top-[-19.44%]"
              src={imgIconView3}
            />
          </div>
          <Content6 />
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="font-['SF_Pro_Text:Regular',sans-serif] relative shrink-0 text-[14px] text-[rgba(4,4,19,0.55)] w-full">
            Карта настраивается под ваши потребности
          </p>
        </div>
        <div
          className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full"
      ...
      >
        ...
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img
              alt=""
              className="absolute left-[-42.5%] max-w-none size-[180%] top-[-45%]"
              src={imgIconView4}
            />
          </div>
          <Content7 />
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="font-['SF_Pro_Text:Regular',sans-serif] relative shrink-0 text-[14px] text-[rgba(4,4,19,0.55)] w-full">
            Валютные переводы м/у юрлицами в валюте онлайн
          </p>
        </div>
        <div
          className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full"
      ...
      >
        ...
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img
              alt=""
              className="absolute left-[-12.5%] max-w-none size-[135%] top-[-13.68%]"
              src={imgIconView5}
            />
          </div>
          <Content8 />
      ...
      >
        ...
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img
              alt=""
              className="absolute left-[-4.77%] max-w-none size-[108.93%] top-[-8.33%]"
              src={imgIconView6}
            />
          </div>
          <Content9 />
...
function TopSlot5() {
  return (
    ...
    >
      <div
        className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-px relative w-full"
        data-name="TopSlot"
      >
        <Graphic5 />
        <div
          className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start leading-[20px] min-h-px min-w-px not-italic relative w-full"
          data-name="Text Content"
        >
          <p className="[text-decoration-skip-ink:none] decoration-dotted font-['SF_Pro_Text:Bold',sans-serif] relative shrink-0 text-[16px] text-[rgba(3,3,6,0.88)] underline w-full">
      ...
      >
        ...
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img
              alt=""
              className="absolute h-[194.35%] left-[-36.3%] max-w-none top-[-42.36%] w-[179.01%]"
              src={imgIconView7}
            />
          </div>
          <Content10 />
...
function List() {
  return (
    <div className="relative shrink-0 w-full" data-name="list">
      <div className="overflow-clip rounded-[inherit] size-full px-[16px]">
        <div
...
function Content2() {
  return (
    <div
      className="bg-white content-stretch flex flex-col gap-[24px] items-start pb-[24px] relative shrink-0 w-full"
      data-name="content"
    >
      <Head />
      <div
        className="content-stretch flex items-center px-[16px] relative shrink-0 w-full"
        data-name="wip6 / M_CredCard"
      >
        <CardMain />
      </div>
      <List />
  ...
  return (
    ...
    >
      <div className="content-stretch flex flex-col items-start px-[24px] relative w-full">
        <div
          className="bg-[#121213] h-[24px] opacity-0 shrink-0 w-full"
          data-name="Spacer24px"
        />
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      >
        <g id="Shape">
          <path
            d={svgPaths.p3ed8eb00}
            fill="var(--fill-0, #F2F3F5)"
            id="Shape_2"
          />
        </g>
      </svg>
...
function City() {
  return (
    <div
      ...
      data-name="City"
    >
      <p className="font-['SF_Pro_Text:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-[rgba(255,255,255,0.94)] whitespace-nowrap">
        Москва
      </p>
    </div>
  );
...
function Group() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1">
      <div
        className="col-1 ml-0 mt-0 overflow-clip relative row-1 size-[24px]"
        data-name="Size=m"
      >
        <div
          className="absolute inset-[20.83%_0_20.83%_64.58%]"
          data-name="icon"
        >
          <svg
            className="absolute block size-full"
...
function Graphic7() {
  return (
    ...
    >
      <Group />
      <div
        className="bg-[#4a4a51] col-1 ml-0 mt-0 row-1 size-[24px]"
        data-name="Color"
      />
    </div>
  );
...
function RightAddon() {
  return (
    <div
      className="content-stretch flex items-center justify-center relative self-stretch shrink-0"
      data-name="RightAddon"
    >
      <Graphic7 />
    </div>
  );
...
function TopSlot7() {
  return (
    ...
    >
      ...
      >
        <div
          className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[20px] min-h-px min-w-px not-italic relative"
          data-name="Text Content"
        >
          <p className="font-['SF_Pro_Text:Medium',sans-serif] relative shrink-0 text-[16px] text-[rgba(255,255,255,0.94)] w-full">
            +7 495 755 58 58
          </p>
          <p className="font-['SF_Pro_Text:Regular',sans-serif] relative shrink-0 text-[14px] text-[rgba(238,238,251,0.55)] w-full">
            Бизнесу
          </p>
        </div>
        <RightAddon />
...
function Phones() {
  return (
    ...
    >
      <div
        className="content-stretch flex flex-col items-start max-w-[328px] relative shrink-0 w-full"
        data-name="Business"
      >
        <TopSlot7 />
      </div>
...
function LinkSlot() {
  return (
    <div
      ...
      data-name="LinkSlot"
    >
      <p className="font-['SF_Pro_Text:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(255,255,255,0.94)] whitespace-nowrap">
        Курсы валют
      </p>
    </div>
  );
...
function ShapeContent9() {
  return (
    <div
      className="absolute left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[32px_32px] size-[24px] top-0"
      data-name="ShapeContent"
      style={{ maskImage: `url('${imgShapeContent3}')` }}
    >
      <div
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <div
        className="content-stretch flex items-start max-h-[24px] max-w-[24px] min-h-[24px] min-w-[24px] relative shrink-0"
        data-name="IconView"
      >
        <Content13 />
      </div>
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      ...
      >
        <div
          className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[40px_40px]"
          data-name="Vector"
        ...
        >
          ...
          >
            <path
              d="M0 0H24V24H0V0Z"
              fill="var(--fill-0, #EE1C25)"
              id="Vector"
            />
          </svg>
        </div>
        <div
          className="absolute inset-[10%_60%_63%_10%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-4px_-4px] mask-size-[40px_40px]"
          data-name="Vector"
          style={{ maskImage: `url('${imgVector}')` }}
        >
          <svg
        ...
        <div className="absolute flex inset-[3.62%_43.94%_83.18%_43.21%] items-center justify-center">
          <div className="-rotate-121 flex-none h-[2.159px] w-[2.398px]">
            <div
              className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-17.283px_-1.45px] mask-size-[40px_40px] relative size-full"
              data-name="Vector"
              style={{ maskImage: `url('${imgVector}')` }}
            >
              <svg
                ...
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 2.39838 2.15854"
              >
                <path
                  d={svgPaths.p141cc080}
                  fill="var(--fill-0, #FFFF00)"
                  id="Vector"
                />
              </svg>
        ...
        <div className="absolute flex inset-[14.5%_35.36%_74.33%_54.32%] items-center justify-center">
          <div className="flex-none h-[2.16px] rotate-[-98.1deg] w-[2.4px]">
            <div
              className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-21.729px_-5.8px] mask-size-[40px_40px] relative size-full"
              data-name="Vector"
              style={{ maskImage: `url('${imgVector}')` }}
            >
              <svg
        ...
        <div className="absolute flex inset-[28.83%_34.83%_59.07%_53.75%] items-center justify-center">
          <div className="-rotate-74 flex-none h-[2.161px] w-[2.401px]">
            <div
              className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-21.501px_-11.53px] mask-size-[40px_40px] relative size-full"
              data-name="Vector"
              style={{ maskImage: `url('${imgVector}')` }}
            >
              <svg
                ...
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 2.40128 2.16116"
              >
                <path
                  d={svgPaths.p191b1e00}
                  fill="var(--fill-0, #FFFF00)"
                  id="Vector"
                />
              </svg>
        ...
        <div className="absolute flex inset-[37.97%_43.75%_48.6%_42.98%] items-center justify-center">
          <div className="flex-none h-[2.159px] rotate-[-51.3deg] w-[2.399px]">
            <div
              className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-17.19px_-15.19px] mask-size-[40px_40px] relative size-full"
              data-name="Vector"
              style={{ maskImage: `url('${imgVector}')` }}
            >
              <svg
                ...
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 2.39883 2.15895"
              >
                <path
                  d={svgPaths.p2f125100}
                  fill="var(--fill-0, #FFFF00)"
                  id="Vector"
                />
              </svg>
      ...
      <p
        className="font-['SF_Pro_Text:Regular','Noto_Sans_JP:Regular',sans-serif] leading-[16px] relative shrink-0 text-[12px] text-[rgba(255,255,255,0.94)] whitespace-nowrap"
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      ...
      <p className="font-['SF_Pro_Text:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.94)] whitespace-nowrap">
        Eng
      </p>
    </div>
  );
...
function Chinese() {
  return (
    <div
      className="content-stretch flex flex-[1_0_0] gap-[24px] h-full items-center justify-end min-h-px min-w-px relative"
      data-name="Chinese"
    >
      <Frame1 />
      <Frame2 />
...
function Content12() {
  return (
    <div
      className="content-stretch flex flex-col gap-[24px] items-start pt-[24px] relative rounded-[16px] shrink-0 w-full"
      data-name="Content"
    >
      <InfoText />
    </div>
...
function Content11() {
  return (
    <div
      className="content-stretch flex flex-col items-center pb-[72px] relative shrink-0 w-full z-[1]"
      data-name="Content"
    >
      <BreadCrumbs />
      <Info />
...
function Body() {
  return (
    <div
      className="absolute bg-white content-stretch flex flex-col gap-[8px] items-center left-0 pt-[24px] top-[56px] w-[360px]"
      data-name="body"
    >
      <Content2 />
      <div
        className="bg-[#121213] content-stretch flex flex-col isolate items-start overflow-clip relative rounded-tl-[32px] rounded-tr-[32px] shrink-0 w-[360px]"
        data-name="Footer"
      >
        <Content11 />
      </div>
...
export default function MPrelogin() {
  return (
    <div
      className="bg-[#131315] relative size-full"
      data-name="[M]-Prelogin"
    >
      <FixedFooter />
      <Body />
      <div
        className="absolute h-[94px] left-0 top-0 w-[360px]"
        data-name="MobileHeader"
      >
        <div
          className="absolute h-[86px] left-0 right-0 top-0"
          data-name="Subtract"
        >
          <svg
            className="absolute block size-full"
          ...
          >
            <path
              clipRule="evenodd"
              d={svgPaths.p1e262e00}
              fill="var(--fill-0, #131315)"
              fillRule="evenodd"
              id="Subtract"
            />
          </svg>
